...
**A developer setup wizard + structured, multilingual exercise dataset — scaffold your own exercise app backend (DB schema, API code, LLM prompt) over 1,324 exercises with category, body-part, equipment, target and muscle-group data and step-by-step instructions in 7 languages (English, Spanish, Italian, Turkish, Russian, Chinese, Farsi). Exercise media is not included.**
...
>
> There are **multiple, conflicting ownership claims** over this media, so it is **not redistributed in this repository.** Each record keeps a `media_id` (the original ExerciseDB media reference); the dataset itself ships exercise metadata and multilingual instruction translations (EN, ES, IT, TR, RU, ZH, FA).
>
...
- 🇪🇸 Spanish, 🇮🇹 Italian, 🇹🇷 Turkish, 🇷🇺 Russian, 🇨🇳 Chinese, and 🇮🇷 Farsi translations of the instructions
...
| Available Languages | 🇬🇧 English · 🇪🇸 Spanish · 🇮🇹 Italian · 🇹🇷 Turkish · 🇷🇺 Russian · 🇨🇳 Chinese · 🇮🇷 Farsi |
...
- Click any card to see full details and instructions in English, Spanish, Italian, Turkish, Russian, Chinese, or Farsi
...
| `instructions.fa` | `string` | Full step-by-step instructions in Farsi |
...
```json
{
  ...
  "instructions": {
    ...
    "zh": "平躺，膝盖弯曲，双脚平放在地上。...",
    "fa": "به پشت دراز بکشید و زانوهایتان را خم کنید ..."
  },
